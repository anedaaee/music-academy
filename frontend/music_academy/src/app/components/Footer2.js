                    ...
                    <div className="col-lg-6 col-md-6">
                        <div className="footer-info">
                                ...
                                <p>
                                    ...
                                    <Instagram sx={{marginLeft:"20px"}}/> <Link style={{color:"#000",textDecoration:"none"}} href='https://www.instagram.com/mahjoubi.music.academy?igsh=MXgyaXgzemxoa3h5eA=='>mahjoubi.music.academy</Link><br/>
