                    ...
                    <Grid2 container spacing={2} sx={{height:"100%"}}>
                        <Grid2 item size={{xs:12,md:12}}>
                            ...
                            <Select fullWidth sx={input_style}  labelId="status-label" value={session.status} onChange={(e) => onChange(e.target.value,'status')}>
                                ...
                                <MenuItem value={'valid_absence'}>Valid Absence</MenuItem>
                                <MenuItem value={'invalid_absence'}>Invalid Absence</MenuItem>
                            </Select>
                        </Grid2>
                        <Grid2 item size={{xs:12,md:12}}>
                            <TextField  fullWidth sx={input_style} label='Description' placeholder='Description' defaultValue={session.description} onChange={(e) => onChange(e.target.value,'description')} multiline/>
                        </Grid2>
                        <Grid2 item size={{xs:12,md:12}}>
                            <div dir="ltr" sx={{width:'100%'}}>
