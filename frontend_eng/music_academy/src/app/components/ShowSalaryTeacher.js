...
const ShowSalaryTeacher = (props) => {
    const columns = [
        ...
        { field: 'class_count', headerName: 'Number Of Session', width: 150, sortable: true,align: 'right',headerAlign: 'right', headerClassName:'grid-header'},
...
export default ShowSalaryTeacher