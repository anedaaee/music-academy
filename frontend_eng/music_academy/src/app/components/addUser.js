"use client";
import { Grid2,Button,createTheme,alpha,getContrastRatio,CardContent,TextField,IconButton, InputAdornment} from "@mui/material";
                ...
                <form style={{ display: 'flex', flexDirection: 'column', flexGrow: 1, width: '100%', height: '100%' , display:'flex',justifyContent:'center',alignItems:'center'}}>
                    <Grid2 container spacing={2} sx={{height:"100%"}}>
                        <Grid2 item size={{xs:12,md:12}}>
                            <TextField  fullWidth sx={input_style} label='Username' placeholder='Username' defaultValue={user.username} onChange={(e) => onChange(e.target.value,'username')}/>
                        </Grid2>
                        <Grid2 item size={{xs:12,md:12}}>
                            <TextField
                                fullWidth
