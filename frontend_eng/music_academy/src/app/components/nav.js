    ...
    return (
        <Grid2 item xs={12} sm={4} sx={{width:isMobile?"100vw":"10%"
            ...
            <Box sx={{display:isMobile?'none':'block',position:'fixed',top:'10px'}}>
                <Avatar alt={'mahjoubiIcon'} src="/icon.png" sx={{ width: 100, height: 100 }}/>
                <Typography sx={{color:'#000',fontFamily: 'Amiri',fontSize:'20px',marginTop:'5px'}}>Nak English</Typography>
            </Box>
            <IconButton onClick={() => changeState('classes')} sx={{"&:hover": {
                ...
                <Box sx={{
                    ...
                    {
                    !isMobile?
                        <Typography sx={{color:state=='classes'?theme.palette.violet.main:'#000'}}>Classes</Typography>
                    :null
                    }
                </Box>
            </IconButton>
            <IconButton onClick={() => changeState('teachers')} sx={{"&:hover": {
                ...
                <Box sx={{display:"flex"
                    ...
                    {
                    !isMobile?
                        <Typography sx={{color:state=='teachers'?theme.palette.violet.main:'#000',margin:"10px"}}>Teachers</Typography>
                    :null
                    }
                </Box>
            </IconButton>
            <IconButton onClick={() => changeState('admins')} sx={{"&:hover": {
                ...
                <Box sx={{display:"flex"
                    ...
                    {
                    !isMobile?
                        <Typography sx={{color:state=='admins'?theme.palette.violet.main:'#000',margin:"10px"}}>Admins</Typography>
                    :null
                    }
                </Box>
            </IconButton>
            <IconButton onClick={() => changeState('users')} sx={{"&:hover": {
                ...
                <Box sx={{display:"flex",
                    ...
                    {
                    !isMobile?
                        <Typography sx={{color:state=='users'?theme.palette.violet.main:'#000',margin:"10px"}}>Students</Typography>
                    :null
                    }
                </Box>
            </IconButton>
            <IconButton onClick={() => changeState('account')} sx={{"&:hover": {
                ...
                <Box sx={{display:"flex",
                    ...
                    {
                    !isMobile?
                        <Typography sx={{color:state=='account'?theme.palette.violet.main:'#000',margin:"10px"}}>My Profile</Typography>
                    :null
                    }
                </Box>
            </IconButton>
            <IconButton onClick={() => {
                ...
                <Box sx={{display:"flex",
                    ...
                    {
                    !isMobile?
                        <Typography sx={{color:state=='logout'?theme.palette.violet.main:'#000',margin:"10px"}}>Logout</Typography>
                    :null
                    }
                </Box>
            </IconButton>
