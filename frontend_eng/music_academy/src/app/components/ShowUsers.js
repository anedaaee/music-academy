...
const ShowUsers = (props) => {
    const columns = [
      ...
      { field: 'username', headerName: 'Username', width: 150, sortable: true, headerClassName:'grid-header' },
      { field: 'name', headerName: 'Name', width: 200, sortable: true,align: 'left',headerAlign: 'left', headerClassName:'grid-header', renderCell: (params) => (params.row.name ? params.row.name : '-')},
      { field: 'last_name', headerName: 'Last name', width: 200, sortable: true ,align: 'left',headerAlign: 'left', headerClassName:'grid-header', renderCell: (params) => (params.row.last_name ? params.row.last_name : '-')},
      { field: 'mobile', headerName: 'Phone Number', width: 200, sortable: true , headerClassName:'grid-header', renderCell: (params) => (params.row.mobile ? params.row.mobile : '-')},
      { field: 'national_id', headerName: 'National Id', width: 200, sortable: true , headerClassName:'grid-header', renderCell: (params) => (params.row.national_id ? params.row.national_id : '-')},
      { field: 'email', headerName: 'Email', width: 200, sortable: true , headerClassName:'grid-header', renderCell: (params) => (params.row.email ? params.row.email : '-')},
      { field: 'is_active', headerName: 'Active Status', width: 200, sortable: true , headerClassName:'grid-header', renderCell: (params) => (
