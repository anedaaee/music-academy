...
const ShowUser2 = ({username,onError}) => {
            ...
            :   
                ...
                <form style={{ display: 'flex', flexDirection: 'column', flexGrow: 1, width: '100%', height: '100%' , display:'flex',justifyContent:'center',alignItems:'center'}}>
                    <Grid2 container spacing={2} >
                        ...
                        <Grid2 item size={{xs:12,md:6}}>
                            <TextField  fullWidth sx={input_style} label='Phone Number' placeholder='Phoner Number' defaultValue={user.phone} onChange={(e) => onChange(e.target.value,'phone')}/>
                        </Grid2>
                        <Grid2 item size={{xs:12,md:6}}>
                ...
                <form style={{ display: 'flex', flexDirection: 'column', flexGrow: 1, width: '100%', height: '100%' , display:'flex',justifyContent:'center',alignItems:'center'}}>
                    <Grid2 container spacing={2} >
                        ...
                        {
                            user.is_active?
                            <Button variant='contained' loading={deleteLoading} style={{backgroundColor:'transparent',border:'1px solid red',color:'red'}} sx={{ marginRight: 3.5 }} onClick={(e) => deleteUser()}>Delete</Button>
                            :
                            <Button variant='contained' loading={deleteLoading} style={{backgroundColor:'transparent',border:'1px solid green',color:'green'}} sx={{ marginRight: 3.5 }} onClick={(e) => refactoreUser()}>Refactore</Button>
                        }
                        </Grid2>
                        <Grid2 item size={{xs:12,md:6}}>
