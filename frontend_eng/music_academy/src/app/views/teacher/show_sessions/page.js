...
export default function ShowSessions() {
  const columns = [
    { field: 'id', headerName: 'Session ID', width: 100, sortable: true, headerClassName:'grid-header' },
    { field: 'status', headerName: 'Status', width: 200, sortable: true,align: 'left',headerAlign: 'left', headerClassName:'grid-header',renderCell: (params) => (params.row.status=='invalid_absence' ? 'Invalid Absence' : params.row.status=='valid_absence'?'Valid Absence':'Present')},
    { field: 'price', headerName: 'Fee', width: 200, sortable: true ,align: 'left',headerAlign: 'left', headerClassName:'grid-header'},
    { field: 'description', headerName: 'Description', width: 200, sortable: true , headerClassName:'grid-header'},
    { field: 'session_date', headerName: 'Date', width: 300, sortable: true , headerClassName:'grid-header', renderCell: (params) => (moment(params.row.session_date).locale('fa').format('YYYY/MM/DD'))},
  ]
