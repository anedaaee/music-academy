                        ...
                        <Grid2 container spacing={2} >
                            ...
                            <Grid2 item size={{xs:12,md:12}}>
                                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                    ...
                                    <h3 style={{marginLeft:'10px',color:theme.palette.primary.light}}>Username : <span style={{color:'#939393',fontWeight:'lighter',color:theme.palette.primary.dark}}>{teacher.username}</span></h3>
                                </Box>
                            </Grid2>
                            <Grid2 item size={{xs:12,md:6}}>
                                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                    <Info sx={{color:theme.palette.violet.light}}/>
                                    <h3 style={{marginLeft:'10px',color:theme.palette.primary.light}}>Name : <span style={{color:'#939393',fontWeight:'lighter',color:theme.palette.primary.dark}}>{teacher.name?teacher.name:'---'}</span></h3>
                                </Box>
                            </Grid2>
                            <Grid2 item size={{xs:12,md:6}}>
                                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                    <Info sx={{color:theme.palette.violet.light}}/>
                                    <h3 style={{marginLeft:'10px',color:theme.palette.primary.light}}>Last Name : <span style={{color:'#939393',fontWeight:'lighter',color:theme.palette.primary.dark}}>{teacher.last_name?teacher.last_name:'---'}</span></h3>
                                </Box>
                            </Grid2>
                            <Grid2 item size={{xs:12,md:6}}>
                                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                    <Phone sx={{color:theme.palette.violet.light}}/>
                                    <h3 style={{marginLeft:'10px',color:theme.palette.primary.light}}>Mobile Number : <span style={{color:'#939393',fontWeight:'lighter',color:theme.palette.primary.dark}}>{teacher.mobile?teacher.mobile:'---'}</span></h3>
                                </Box>
                            </Grid2>
                            <Grid2 item size={{xs:12,md:6}}>
                                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                    <Phone sx={{color:theme.palette.violet.light}}/>
                                    <h3 style={{marginLeft:'10px',color:theme.palette.primary.light}}>Phone Number : <span style={{color:'#939393',fontWeight:'lighter',color:theme.palette.primary.dark}}>{teacher.phone?teacher.phone:'---'}</span></h3>
                                </Box>
                            </Grid2>
                            <Grid2 item size={{xs:12,md:6}}>
                                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                    <Email sx={{color:theme.palette.violet.light}}/>
                                    <h3 style={{color:theme.palette.primary.light}}>Email : <span style={{color:'#939393',fontWeight:'lighter',color:theme.palette.primary.dark}}>{teacher.email?teacher.email:'---'}</span></h3>
                                </Box>
                            </Grid2>
                            <Grid2 item size={{xs:12,md:6}}>
                                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                    <QrCode sx={{color:theme.palette.violet.light}}/>
                                    <h3 style={{color:theme.palette.primary.light}}>National ID : <span style={{color:'#939393',fontWeight:'lighter',color:theme.palette.primary.dark}}>{teacher.national_id?teacher.national_id:'---'}</span></h3>
                                </Box>
                            </Grid2>
                            <Grid2 item size={{xs:12,md:12}}>
                                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                    <LocationOn sx={{color:theme.palette.violet.light}}/>
                                    <h3 style={{color:theme.palette.primary.light}}>Address : <span style={{color:'#939393',fontWeight:'lighter',color:theme.palette.primary.dark}}>{teacher.address?teacher.address:'---'}</span></h3>
                                </Box>
                            </Grid2>
                        </Grid2>
                    </form>
